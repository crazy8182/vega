...
async def give_filter(client, message):
    if message.chat.id != SUPPORT_CHAT_ID:
       ...
       f"Jᴏɪɴ ᴀɴᴅ Sᴇᴀʀᴄʜ Hᴇʀᴇ - <a href='https://t.me/+A4tVZCXbK2s2YzJl'> Movie group </a>"
       ...
       f"आपको मूवी हमारे मूवी 🍿 ग्रुप में मिलेगी, इसलिए वहां सर्च 🔍 करें - <a href='https://t.me/+A4tVZCXbK2s2YzJl'> Movie group </a></b>",
...
async def pm_text(bot, message):
    ...
    message_text = (
        ...
        f"<a href=https://t.me/+A4tVZCXbK2s2YzJl>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> ᴏʀ ᴄʟɪᴄᴋ Movie group ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇\n\n"
        f"नमस्कार {user_link} 😍,\n\n"
        f"आपको यहां पर movie 🍿 नहीं मिलेगी कृपया हमारे "
        f"<a href=https://t.me/+A4tVZCXbK2s2YzJl>ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ</a> में search 🔎 करें या "
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    # don't change anything without contacting me @creatorrio
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('❓How to Download', url="https://t.me/vegamoviesnewin/277"),
        ...
        buttons = [[
            InlineKeyboardButton('👨‍💻Sᴜᴘᴘᴏʀᴛ Gʀᴏᴜᴘ', url="https://t.me/akDiscussion_group"),
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("😇Cᴏɴᴛᴀᴄᴛ😇", url="telegram.me/Mahesh8182")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
